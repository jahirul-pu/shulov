...
const mockCategoryProducts: Product[] = [
  {
    ...
    description: 'Crisp red apples from organic mountain orchards.',
    brand: 'Orchard Fresh',
    ...
    categoryId: 'c1',
    variants: [
      { id: 'v101', productId: 'cp1', weight: '500g', unit: 'g', price: 2.49, originalPrice: 3.2, stock: 45, sku: 'APP-500G' },
      { id: 'v102', productId: 'cp1', weight: '1kg', unit: 'kg', price: 4.49, originalPrice: 5.99, stock: 80, sku: 'APP-1KG' },
    ],
  },
  {
    id: 'cp2',
    ...
    categoryId: 'c1',
    variants: [
      { id: 'v103', productId: 'cp2', weight: '1 Dozen (12 pcs)', unit: 'doz', price: 1.89, originalPrice: 2.4, stock: 120, sku: 'BAN-1DOZ' },
    ],
  },
  {
    id: 'cp3',
    ...
    categoryId: 'c1',
    variants: [
      { id: 'v104', productId: 'cp3', weight: '250g Pack', unit: 'g', price: 1.99, originalPrice: 2.5, stock: 30, sku: 'SPI-250G' },
    ],
  },
];
